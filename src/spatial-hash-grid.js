...
export const spatial_hash_grid = (() => {
  //   constructor(bounds, dimensions): Phương thức khởi tạo lưới băm không gian với giới hạn bounds và kích thước dimensions.

  // NewClient(position, dimensions): Phương thức tạo một đối tượng mới và chèn nó vào lưới băm.

  // UpdateClient(client): Phương thức cập nhật vị trí của một đối tượng trong lưới băm.

  // FindNear(position, bounds): Phương thức tìm kiếm các đối tượng gần với một vị trí và giới hạn xác định.

  // _Insert(client): Phương thức chèn một đối tượng vào lưới băm.

  // Remove(client): Phương thức xóa một đối tượng khỏi lưới băm.
